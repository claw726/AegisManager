...
public class ProjectController {
  ...
  public ResponseEntity<String> createProject(
    ...
    @RequestParam int projectOwnerID,
    @RequestParam int parentOrgID,
    @RequestParam String encodedImage
  ) {
    try {
      logger.info(
        "Received project creation request with name: {}, description: {}, owner ID: {}, parent org ID: {}",
        projectName,
        projectDescription,
        projectOwnerID,
        parentOrgID
      ...
      if (
        e.getMessage().contains("Project with given name already exists in org")
      ) {
        ...
        return ResponseEntity.internalServerError()
          .body("There was an error creating the project");
      }
    }
  }
  ...
  public ResponseEntity<ProjectDTO> getProject(@PathVariable int projectID) {
    try {
      ...
      if (e.getMessage().contains("Project not found with id:")) {
        ...
        e.getMessage().contains("User does not have permission to get project")
      ) {
        logger.info(
  ...
  public ResponseEntity<String> updateProject(
    ...
    try {
      ...
      if (e.getMessage().contains("Project not found with id:")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to update project")
      ) {
  ...
  public ResponseEntity<String> deleteProject(@PathVariable int projectID) {
    try {
      ...
      if (e.getMessage().contains("Project not found with id:")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to delete project")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<String> addUsers(
    ...
    try {
      ...
      if (e.getMessage().contains("User not found with id: ")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to add user to project")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<String> removeUser(
    ...
    try {
      ...
      if (e.getMessage().contains("User not found with email:")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to remove user from project")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<Set<TaskDTO>> getAllTasksFromProject(
    @PathVariable int projectID
  ) {
    try {
      ...
      if (e.getMessage().contains("Project not found with id:")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to get tasks from project")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(null);
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<Set<UserDTO>> getUsers(@PathVariable int projectID) {
    try {
      ...
      if (e.getMessage().equals("Project not found with ID: " + projectID)) {
        ...
        e.getMessage().contains("User does not have permission to view users")
      ) {
  ...
  public ResponseEntity<Set<TaskDTO>> getAllTasksForUser(
    @PathVariable int projectID,
    @RequestParam String email
  ) {
    try {
  ...
  public ResponseEntity<String> changeArchivedStatus(
    @PathVariable int projectID,
    ...
    try {
      ...
      return ResponseEntity.ok(
        "Project archived status changed to " + isArchived + " successfully"
      );
    } catch (RuntimeException e) {
      if (e.getMessage().contains("Project not found with id:")) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(e.getMessage());
        ...
        e
          .getMessage()
          .contains("User does not have permission to change archived status")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
