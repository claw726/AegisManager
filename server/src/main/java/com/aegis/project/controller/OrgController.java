...
public class OrgController {
  ...
  public ResponseEntity<String> createOrg(
    ...
    @RequestParam String orgDescription,
    @RequestParam int orgOwnerID,
    @RequestParam String encodedImage
  ) {
    try {
      logger.info(
        "Received org creation request with name: {}, description: {}, owner ID: {}, encodedImage: {}",
        orgName,
        orgDescription,
        orgOwnerID,
        encodedImage
      ...
      return ResponseEntity.internalServerError()
        .body("There was an error creating the org");
    }
  }
  ...
  public ResponseEntity<OrgDTO> getOrg(@PathVariable int orgID) {
    try {
      ...
      if (e.getMessage().contains("Org not found with id:")) {
        ...
        e.getMessage().contains("User does not have permission to get org")
      ) {
  ...
  public ResponseEntity<Set<ProjectDTO>> getAllProjectsFromOrg(
    @PathVariable int orgID
  ) {
    try {
      logger.info(
        "Received request to get all projects from org with ID: {}",
        orgID
      );
      Set<ProjectDTO> projects = orgService.getAllProjectsFromOrg(orgID);
      logger.info(
        "Returning {} projects from org with ID: {}",
        projects.size(),
        orgID
      );
      ...
      if (e.getMessage().contains("Org not found with ID:")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to get projects from org")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(null);
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<String> updateOrg(
    ...
    try {
      ...
      if (e.getMessage().contains("Org not found with id:")) {
        ...
        e.getMessage().contains("User does not have permission to update org")
      ) {
  ...
  public ResponseEntity<String> deleteOrg(@PathVariable int orgID) {
    try {
      ...
      if (e.getMessage().contains("Org not found with id:")) {
        ...
        e.getMessage().contains("User does not have permission to delete org")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<String> addUser(
    ...
    try {
      ...
      if (e.getMessage().contains("User not found with email: ")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to add user to org")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<String> removeUser(
    ...
    try {
      ...
      if (e.getMessage().contains("User not found with email: ")) {
        ...
        e
          .getMessage()
          .contains("User does not have permission to remove user from org")
      ) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(e.getMessage());
      } else {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
  ...
  public ResponseEntity<Set<ProjectDTO>> getArchivedProjects(
    @PathVariable int orgID
  ) {
    logger.info(
      "Received request to get archived projects from org with ID: {}",
      orgID
    );
    try {
      ...
      if (e.getMessage().contains("Org not found with id:")) {
        ...
        e
          .getMessage()
          .contains("There are no archived projects accessible by this user")
      ) {
        logger.error(e.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(null);
      } else {
