...
public class ProjectControllerTest {
  ...
  public void testCreateProject_Success() {
    ...
    ResponseEntity<String> response = projectController.createProject(
      projectName,
      projectDescription,
      projectOwnerID,
      parentOrgID,
  ...
  public void testGetProject_Success() {
    ...
    ResponseEntity<ProjectDTO> response = projectController.getProject(
      projectID
    );
  ...
  public void testGetProject_NotFound() {
    ...
    when(projectService.getProject(projectID)).thenThrow(
  ...
  public void testUpdateProject_Success() {
    ...
    ResponseEntity<String> response = projectController.updateProject(
      projectID,
      projectName,
      projectDescription,
      projectOwnerID,
  ...
  public void testDeleteProject_Success() {
    ...
    ResponseEntity<String> response = projectController.deleteProject(
      projectID
    );
  ...
  public void testAddUsers_Success() {
    ...
    ResponseEntity<String> response = projectController.addUsers(
      projectID,
      userIDs
    );
  ...
  public void testAddUser_Success() {
    ...
    ResponseEntity<String> response = projectController.addUser(
      projectID,
      email
    );
  ...
  public void testRemoveUser_Success() {
    ...
    ResponseEntity<String> response = projectController.removeUser(
      projectID,
      email
    );
  ...
  public void testGetAllTasksFromProject_Success() {
    ...
    ResponseEntity<Set<TaskDTO>> response =
      projectController.getAllTasksFromProject(projectID);
  ...
  public void testGetAllTasksFromProject_NotFound() {
    ...
    doThrow(new RuntimeException("Project not found with id: " + projectID))
      .when(projectService)
      .getAllTasksFromProject(projectID);
  ...
  public void testGetUsers_Success() {
    ...
    ResponseEntity<Set<UserDTO>> response = projectController.getUsers(
      projectID
    );
  ...
  public void testGetAllTasksForUser_Success() {
    ...
    ResponseEntity<Set<TaskDTO>> response =
      projectController.getAllTasksForUser(projectID, email);
  ...
  public void testGetAllTasksForUser_NotFound() {
    ...
    doThrow(new RuntimeException("Project not found with ID: " + projectID))
      .when(projectService)
      .getAllTasksForUser(projectID, email);
  ...
  public void testChangeArchivedStatus_Success() {
    ...
    doNothing()
      .when(projectService)
      .changeArchivedStatus(projectID, isArchived);

    ResponseEntity<String> response = projectController.changeArchivedStatus(
      projectID,
      isArchived
    );
