...
public class OrgControllerTest {
  ...
  public void testCreateOrg_Success() {
    ...
    ResponseEntity<String> response = orgController.createOrg(
      orgName,
      orgDescription,
      orgOwnerID,
      encodedImage
  ...
  public void testCreateOrg_Error() {
    ...
    doThrow(new RuntimeException("Error creating org"))
      .when(orgService)
      .createOrg(orgName, orgDescription, orgOwnerID, encodedImage);
  ...
  public void testGetOrg_NotFound() {
    ...
    doThrow(new RuntimeException("Org not found with id: " + orgID))
      .when(orgService)
      .getOrg(orgID);
  ...
  public void testGetAllProjectsFromOrg_Success() {
    ...
    ResponseEntity<Set<ProjectDTO>> response =
      orgController.getAllProjectsFromOrg(orgID);
  ...
  public void testUpdateOrg_Success() {
    ...
    doNothing()
      .when(orgService)
      .updateOrg(orgID, orgName, orgDescription, orgOwnerID, encodedImage);

    ResponseEntity<String> response = orgController.updateOrg(
      orgID,
      orgName,
      orgDescription,
      orgOwnerID,
  ...
  public void testGetAllOrgs_Error() {
    when(orgService.getAllOrgs()).thenThrow(
      new RuntimeException("Error fetching orgs")
    );
  ...
  public void testGetArchivedProjects_Success() {
    ...
    ResponseEntity<Set<ProjectDTO>> response =
      orgController.getArchivedProjects(orgID);
