...
public class AuthControllerTest {
  ...
  public void testCreateUser_Success() {
    ...
    when(
      userService.createUser(email, name, password, profilePicture)
    ).thenReturn(true);

    ResponseEntity<String> response = authController.createUser(
      email,
      name,
      password,
      profilePicture
  ...
  public void testLoginUser_Success() {
    ...
    ResponseEntity<Map<String, String>> response = authController.loginUser(
      email,
      password
    );
  ...
  public void testRequestPasswordReset_Success() {
    ...
    when(
      passwordResetTokenRepository.save(any(PasswordResetToken.class))
    ).thenReturn(new PasswordResetToken());

    ResponseEntity<String> response = authController.requestPasswordReset(
      email
    );
  ...
  public void testResetPassword_Success() {
    ...
    ResponseEntity<String> response = authController.resetPassword(
      token,
      password
    );
  ...
  public void testEnable2FA_Success() {
    ...
    when(twoFactorAuthService.getQRBarcodeURL(userID, secretKey)).thenReturn(
      qrCodeURL
    );
