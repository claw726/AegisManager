...
public class UserControllerTest {
  ...
  public void testUpdateUser_Success() {
    ...
    doNothing()
      .when(userService)
      .updateUser(userID, name, email, profilePicture);

    ResponseEntity<String> response = userController.updateUser(
      userID,
      name,
      email,
      profilePicture
  ...
  public void testUpdateUser_EmailExists() {
    ...
    doThrow(
      new RuntimeException("User with email: " + email + " already exists")
    )
      .when(userService)
      .updateUser(userID, name, email, profilePicture);
