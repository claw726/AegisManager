<template>
    <div class="flex flex-row place-items-center p-4 border rounded-lg m-4" @click="viewOrganization">
      <img :src="user.profilePicture" alt="🤵" class="w-16 h-16 rounded-full drop-shadow-xl mr-4 text-center text-4xl" />
      <div class="flex-1 flex flex-col">
        <div class="text-lg font-bold text-gray-800 text-left">{{ user.userName }}</div>
