  ...
  <nav class="relative w-full h-20 bg-slate-800 shadow-lg">
    <div class="container mx-auto px-4 h-full">
      <div class="flex justify-between items-center h-full">
        ...
        >
          <i class="fas fa-shield-alt text-2xl text-blue-400 group-hover:text-blue-300 transition-colors"></i>
...
export default {
  ...
  setup() {
    ...
    const defaultProfilePicture = 'https://toppng.com/public/uploads/preview/instagram-default-profile-picture-11562973083brycehrmyv.png';
