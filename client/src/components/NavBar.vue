      ...
      <div class="flex justify-between items-center h-full">
        ...
        <div class="flex items-center space-x-6">
          ...
          <div v-if="isLoggedIn" class="flex items-center space-x-4">
            ...
            <div v-click-outside="closeDropdown" class="relative">
              ...
              <div v-if="isDropdownOpen"
                ...
                <a href="#" class="flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                ...
                <a href="#" class="flex items-center space-x-2 px-4 py-2 text-sm text-red-600 hover:bg-gray-100 w-full text-left"
          ...
          <template v-else>
            ...
            <button class="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md transition-colors shadow-md hover:shadow-lg"
