<template>
  <div v-if="isLoggedIn && proj" class="min-h-screen bg-background">
    ...
    <!-- Notifications -->
    <NotificationComponent v-model:show="notification.show" :type="notification.type" @close="clearNotification">
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="flex flex-col items-center">
            <div class="relative group">
              ...
              <div v-if="currentUser.userID === proj.projectOwnerID" class="absolute bottom-2 right-2">
