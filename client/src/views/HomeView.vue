  ...
  <div class="relative min-h-screen bg-gradient-to-b from-gray-50 to-white">
          ...
          <div class="space-y-8">
            <div class="space-y-4">
              ...
              <p class="text-xl text-gray-600 leading-relaxed">
                A powerful, intuitive project management system that helps teams collaborate, track progress, and achieve goals seamlessly.
              </p>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div class="text-center mb-16">
        ...
        <p class="mt-4 text-xl text-gray-600">Powerful features to help your team stay organized and efficient</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="group p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <p class="text-gray-600">Monitor project progress with interactive dashboards and real-time updates.</p>
        </div>
        ...
        <div class="group p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <p class="text-gray-600">Work together seamlessly with built-in communication tools and shared workspaces.</p>
        </div>
      </div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 md:p-12 overflow-hidden">
        ...
        <div class="relative z-10 max-w-3xl">
          ...
          <p class="text-blue-100 mb-8">Join thousands of teams who are already using Ægis to streamline their projects.</p>
          <div class="flex flex-col sm:flex-row gap-4">
            <button
              @click="goToCreateAcct"
