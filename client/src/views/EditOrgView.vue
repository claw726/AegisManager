            ...
            <div class="relative flex flex-col justify-items-center p-16 mx-96 rounded-lg bg-white drop-shadow-lg">
              <div>
                ...
                <div class="flex flex-col justify-center p-4 bg-white">
                  <label for="projName" class="text-lg font-bold text-gray-800">Organization Name:</label>
                  <input type="text" id="projName" v-model="modifiedOrganization.OrgName" class="w-full border border-gray-300 rounded-lg p-2" />
                </div>

                <!-- Proj Desc -->
                <div class="flex flex-col justify-center p-4 bg-white">
                  <label for="projDescription" class="text-lg font-bold text-gray-800">Organization Description:</label>
                  <textarea id="projDescription" v-model="modifiedOrganization.OrgDescription" class="w-full border border-gray-300 rounded-lg p-2"></textarea>
                </div>

                <!-- Proj Users -->
                <div class="flex flex-col justify-center p-4 bg-white">
                  <label for="projDescription" class="text-lg font-bold text-gray-800">Organizaiton Users:</label>
                  <Button class="dashboard-button" @click="selectUsers">Select Users</Button>
                </div>

                <!-- Proj Img -->
                <div class="w-full md:w-1/2 px-4 mb-4 justify-center">
                  <label class="block text-sm font-semibold text-gray-800 mb-2">Organization Picture</label>
    ...
    methods: {
      ...
      async submitForm() {
        ...
        if (this.modifiedOrganization.OrgCreator !== this.currentUser.email) {
            console.log(this.modifiedOrganization.OrgCreator, this.currentUser.email);
