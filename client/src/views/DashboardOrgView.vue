<template>
  <div v-if="isLoggedIn" class="min-h-screen bg-background">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else class="text-center py-12">
        <div class="animate-pulse flex justify-center items-center">
          ...
          <span class="text-lg text-gray-600">Loading organization data...</span>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div class="bg-white rounded-xl shadow-md p-6">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <button @click="goToCreateProject" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-200">
    ...
    <!-- Projects Grid -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div v-if="org && projects" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <ProjCard
