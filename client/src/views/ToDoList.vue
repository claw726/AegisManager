<template>
  ...
  <div class="bg-background flex flex-col items-center min-h-screen h-full">
    <div class="flex flex-col items-center space-y-8 mt-12 w-full max-w-7xl px-4">
      ...
      <div class="h-1 bg-accent drop-shadow-lg rounded mx-16 flex w-full" /> <!-- Changed flex w-screen to w-full -->
