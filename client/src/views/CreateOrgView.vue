        ...
        <div class="space-y-8">
          ...
          <div class="space-y-2">
              <label for="orgName" class="flex items-center text-lg font-medium text-gray-700"
                  ><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M3 9v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9M3 9l2.111-6.333A2 2 0 0 1 7 1h10a2 2 0 0 1 1.889 1.667L21 9M3 9h18M12 3v6m-4 0v6m8-6v6" />
              </svg>
              Organization Name:
              </label>
                <input
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  methods: {
    ...
    createOrg() {
      ...
      if (!this.newOrg.orgOwnerID) {
        this.showNotification("error", "Error determining your identity! Please log out and back in to continue.")
        return;
      }
      ...
      try {
        ...
        this.showNotification("error", "An error occurred while creating the organization. Please try again.")
      }
    },
